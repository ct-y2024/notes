...
\fancyhead[R]{Кучерук Екатерина Аркадьевна}
...
\newpage
\section{О конспекте:}
\subfile{sections/begin.tex}

\newpage
\section{Основные Алгебраические структуры.}
\subfile{sections/Algebra_struct.tex}

\newpage
\section{Алгебра комплексных чисел.}
\subfile{sections/complex.tex}

\newpage
\section{Линейные пространства.}
\subfile{sections/linear_dimension.tex}
\newpage
\section{Алгебра матриц.}
\subfile{sections/matrix.tex}
\newpage
\section{Системы линейных уравнений.}
\subfile{sections/slnu.tex}
\newpage
\section{Определители.}
\subfile{sections/opredelitel.tex}
\end{document}  
