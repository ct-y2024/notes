...
\author{Чепелин В.А., Давыдов И. М.}
\date{ }
...
\subfile{sections/search_tree.tex}
...
%\newpage
%\section{Для тех кто устал от этих ужасных алгоритмов} % Оставлю тебе решение, нужен ли этот блок в конспекте, пока что оставлю закоменченным
%\subfile{sections/secret.tex}
