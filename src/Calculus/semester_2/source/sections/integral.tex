...
\deff{def:} в $R^2$ $A$ - выпуклое. $L$ - прямая, называется \deff{опорной} к $A$ в точке $x_0$, если $L$ проходит через $x$ и множество лежит в одной полуплоскомти.
...
$I_f$ - среднее значение $f$  на $[a,b]$  $\cfrac{1}{a-b}\integral{a}{b}f$
 ...
 \thmm{Теорема (Неравенство Чёбышева)}
