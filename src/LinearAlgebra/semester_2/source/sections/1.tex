...
\thmm{Теорема 1 (функция от диагонализируемой матрицы. 1 формула)}
...
\thmm{Теорема 2 (функция от диагонализируемой матрицы. 2 формула)}
...
\textbf{Замечание.} $\psi(t) \neq 0$, потому что это нормализованный многочлен - старший коэффициент 1.
