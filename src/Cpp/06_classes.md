...
```
<!-- В изначальном конспекте примеров инвариантов не было, хотя в y2024 Иван Владимирович примерно 20 минут лекции их показывал, поэтому для лучшего понимания были добавлены тривиальные примеры -->
...
<!-- Забавно, что на всех записях всех лет есть эта история -->
...
<!-- очень странная постановка предложения снизу, так что исправлено -->
